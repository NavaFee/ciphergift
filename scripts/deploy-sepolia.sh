#!/usr/bin/env bash
# Deploy CipherGift (vault + packet contract) to Sepolia and regenerate
# the frontend's TS ABIs.
#
# Required env vars:
...
FORGE_ARGS=(
  script/DeployCipherGift.s.sol:DeployCipherGift
...
echo "    packages/site/contracts/*.ts."
