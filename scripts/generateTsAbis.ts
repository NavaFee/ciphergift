/**
 * Generates per-contract files in packages/site/contracts/ from foundry
 ...
 *   packages/site/contracts/<Name>.ts        — non-local chains (tracked)
 *   packages/site/contracts/<Name>.local.ts  — local 31337 overlay (gitignored)
 *
...
const TARGET_DIR = path.join(REPO_ROOT, "packages/site/contracts");
