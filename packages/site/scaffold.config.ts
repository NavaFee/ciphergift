...
if (!rawAlchemyKey && typeof window === "undefined" && process.env.NODE_ENV !== "production") {
...
const scaffoldConfig = {
  ...
  // Mainnet is auto-included for ENS / ETH-price reads; viem's default
  // (eth.merkle.io) doesn't allow browser-origin CORS, so we point at a
  // CORS-friendly public node by default.
  rpcOverrides: {
